...
{
    public partial class ImportersContext : DbContext
    {
        ...
        public ImportersContext(DbContextOptions<ImportersContext> options) : base(options)
        {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.BuyingGroupId });
                ...
                entity.Property(e => e.TenantId).HasDefaultValueSql("('7C57FCD3-517D-4921-BD65-27E1068FD195')");
                ...
                entity.HasOne(d => d.LastEdited)
                    .WithMany(p => p.BuyingGroups)
                    .HasForeignKey(d => new { d.TenantId, d.LastEditedBy })
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.CityId });
                ...
                entity.HasOne(d => d.StateProvinces)
                    .WithMany(p => p.Cities)
                    .HasForeignKey(d => new { d.TenantId, d.StateProvinceId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.ColorId });
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.CountryId });
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.CustomerCategoryId });
            ...
            modelBuilder.Entity<Customers>(entity =>
            {
                ...
                entity.HasOne(d => d.AlternateContact)
                    .WithMany(p => p.CustomersPeople)
                    .HasForeignKey(d => new { d.TenantId, d.AlternateContactPersonId })
                    .HasConstraintName("FK_Sales_Customers_AlternateContactPersonID_Application_People");

                entity.HasOne(d => d.BillToCustomer)
                    .WithMany(p => p.InverseCustomersNavigation)
                    .HasForeignKey(d => new { d.TenantId, d.BillToCustomerId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_Customers_BillToCustomerID_Sales_Customers");

                entity.HasOne(d => d.BuyingGroups)
                    .WithMany(p => p.Customers)
                    .HasForeignKey(d => new { d.TenantId, d.BuyingGroupId })
                    .HasConstraintName("FK_Sales_Customers_BuyingGroupID_Sales_BuyingGroups");

                entity.HasOne(d => d.CustomerCategories)
                    .WithMany(p => p.Customers)
                    .HasForeignKey(d => new { d.TenantId, d.CustomerCategoryId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_Customers_CustomerCategoryID_Sales_CustomerCategories");

                entity.HasOne(d => d.DeliveredTo)
                    .WithMany(p => p.CustomersCities)
                    .HasForeignKey(d => new { d.TenantId, d.DeliveryCityId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_Customers_DeliveryCityID_Application_Cities");

                entity.HasOne(d => d.DeliveryMethods)
                    .WithMany(p => p.Customers)
                    .HasForeignKey(d => new { d.TenantId, d.DeliveryMethodId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_Customers_DeliveryMethodID_Application_DeliveryMethods");

                entity.HasOne(d => d.LastEdited)
                    .WithMany(p => p.CustomersPeopleNavigation)
                    .HasForeignKey(d => new { d.TenantId, d.LastEditedBy })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_Customers_Application_People");

                entity.HasOne(d => d.CustomerCity)
                    .WithMany(p => p.CustomersCitiesNavigation)
                    .HasForeignKey(d => new { d.TenantId, d.PostalCityId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.PrimaryContact)
                    ...
                    .HasForeignKey(d => new { d.TenantId, d.PrimaryContactPersonId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.DeliveryMethodId });
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.InvoiceLineId });
                ...
                entity.HasOne(d => d.LastEdited)
                    .WithMany(p => p.LastEditedInvoiceLines)
                    .HasForeignKey(d => new { d.TenantId, d.LastEditedBy })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_InvoiceLines_Application_People");

                entity.HasOne(d => d.PackageTypes)
                    .WithMany(p => p.InvoiceLines)
                    .HasForeignKey(d => new { d.TenantId, d.PackageTypeId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_InvoiceLines_PackageTypeID_Warehouse_PackageTypes");

                entity.HasOne(d => d.StockItems)
                    .WithMany(p => p.InvoiceLines)
                    .HasForeignKey(d => new { d.TenantId, d.StockItemId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.InvoiceId });
                ...
                entity.HasOne(d => d.AccountPerson)
                    .WithMany(p => p.InvoicesForAccount)
                    .HasForeignKey(d => new { d.TenantId, d.AccountsPersonId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_Invoices_AccountsPersonID_Application_People");

                entity.HasOne(d => d.BillToCustomer)
                    .WithMany(p => p.BillToInvoices)
                    .HasForeignKey(d => new { d.TenantId, d.BillToCustomerId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_Invoices_BillToCustomerID_Sales_Customers");

                entity.HasOne(d => d.ContactPerson)
                    .WithMany(p => p.InvoicesPeopleNavigation)
                    .HasForeignKey(d => new { d.TenantId, d.ContactPersonId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_Invoices_ContactPersonID_Application_People");

                entity.HasOne(d => d.SalesCustomer)
                    .WithMany(p => p.SalesInvoices)
                    .HasForeignKey(d => new { d.TenantId, d.CustomerId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.LastEdited)
                    .WithMany(p => p.LastEditedInvoices)
                    .HasForeignKey(d => new { d.TenantId, d.LastEditedBy })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.PackedBy)
                    .WithMany(p => p.PackedInvoices)
                    .HasForeignKey(d => new { d.TenantId, d.PackedByPersonId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Sales_Invoices_PackedByPersonID_Application_People");

                entity.HasOne(d => d.SoldBy)
                    .WithMany(p => p.SoldInvoices)
                    .HasForeignKey(d => new { d.TenantId, d.SalespersonPersonId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.OrderLineId });
            ...
            modelBuilder.Entity<Orders>(entity =>
            {
                ...
                entity.HasOne(d => d.OrdersNavigation)
                    .WithMany(p => p.InverseOrdersNavigation)
                    .HasForeignKey(d => new { d.TenantId, d.BackorderOrderId })
                    .HasConstraintName("FK_Sales_Orders_BackorderOrderID_Sales_Orders");

                entity.HasOne(d => d.ContactPerson)
                    .WithMany(p => p.OrdersPeople)
                    .HasForeignKey(d => new { d.TenantId, d.ContactPersonId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.PackageTypeId });
            ...
            modelBuilder.Entity<People>(entity =>
            {
                ...
                entity.HasOne(d => d.PeopleNavigation)
                    .WithMany(p => p.InversePeopleNavigation)
                    .HasForeignKey(d => new { d.TenantId, d.LastEditedBy })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.PurchaseOrderLineId });
                ...
                entity.HasOne(d => d.PurchaseOrders)
                    .WithMany(p => p.PurchaseOrderLines)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.PurchaseOrderId });
                ...
                entity.HasOne(d => d.People)
                    .WithMany(p => p.PurchaseOrdersPeople)
                    .HasForeignKey(d => new { d.TenantId, d.ContactPersonId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.PeopleNavigation)
                    .WithMany(p => p.PurchaseOrdersPeopleNavigation)
                    .HasForeignKey(d => new { d.TenantId, d.LastEditedBy })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.Suppliers)
                    .WithMany(p => p.PurchaseOrders)
                    .HasForeignKey(d => new { d.TenantId, d.SupplierId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.SpecialDealId });
                ...
                entity.HasOne(d => d.StockGroups)
                    .WithMany(p => p.SpecialDeals)
                    .HasForeignKey(d => new { d.TenantId, d.StockGroupId })
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.StateProvinceId });
                ...
                entity.HasOne(d => d.Countries)
                    ...
                    .HasForeignKey(d => new { d.TenantId, d.CountryId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.StockGroupId });
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.StockItemId });
                ...
                entity.HasOne(d => d.StockItems)
                    ...
                    .HasForeignKey<StockItemHoldings>(d => new { d.TenantId, d.StockItemId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<StockItems>(entity =>
            {
                ...
                entity.HasOne(d => d.PackageTypes)
                    .WithMany(p => p.StockItemsPackageTypes)
                    .HasForeignKey(d => new { d.TenantId, d.OuterPackageId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.PackageTypesNavigation)
                    .WithMany(p => p.StockItemsPackageTypesNavigation)
                    .HasForeignKey(d => new { d.TenantId, d.UnitPackageId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.StockItemStockGroupId });
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.StockItemTransactionId })
                    .ForSqlServerIsClustered(false);
                ...
                entity.HasIndex(e => new { e.StockItemTransactionId, e.StockItemId, e.TransactionTypeId, e.CustomerId, e.InvoiceId, e.SupplierId, e.PurchaseOrderId, e.TransactionOccurredWhen, e.Quantity, e.LastEditedBy, e.LastEditedWhen, e.TenantId })
                ...
                entity.HasOne(d => d.TransactionType)
                    .WithMany(p => p.StockItemTransactions)
                    .HasForeignKey(d => new { d.TenantId, d.TransactionTypeId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.SupplierCategoryId });
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.SupplierId });
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.SystemParameterId });
                ...
                entity.HasOne(d => d.Cities)
                    .WithMany(p => p.SystemParametersCities)
                    .HasForeignKey(d => new { d.TenantId, d.DeliveryCityId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.CitiesNavigation)
                    .WithMany(p => p.SystemParametersCitiesNavigation)
                    .HasForeignKey(d => new { d.TenantId, d.PostalCityId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.TransactionTypeId });
